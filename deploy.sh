...
generate_secrets() {
    ...
    echo "============================================"
    echo ""
    log_info "Untuk FCM browser config (build-time), isi nilai berikut di .env:"
    ...
    echo ""
    log_info "Runtime server cukup memakai Firebase Admin credentials tanpa VAPID private key."
    echo ""
    echo "============================================"
