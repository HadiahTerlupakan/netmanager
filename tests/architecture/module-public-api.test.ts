...
const largeUiFileBaseline = new Set([
  "app/admin/pengeluaran/RABForm.tsx",
  "app/admin/pengeluaran/ExpensesClient.tsx",
  "app/admin/pengeluaran/RABView.tsx",
...
const dependencyInversionBaseline = new Set([
  ...
  "modules/investor/services/InvestorPortalDashboardService.ts",
  "modules/investor/services/InvestorPortalProjectService.ts",
  "modules/investor/services/InvestorPortalPayoutService.ts",
  "modules/investor/services/InvestorPayoutAdminService.ts",
