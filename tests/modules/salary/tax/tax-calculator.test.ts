...
import { TaxCalculator } from "@/modules/salary/tax/TaxCalculator";
import { InMemoryTaxHistoryProvider } from "@/modules/salary/tax/providers/TaxHistoryProvider";
import type { MonthlyTaxRecord } from "@/modules/salary/tax/providers/TaxHistoryProvider";
...
describe("TaxCalculator", () => {
  describe("Monthly TER calculation", () => {
    it("should use TER brackets when available", () => {
      ...
      const calculator = new TaxCalculator(provider);
