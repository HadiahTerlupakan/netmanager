...
describe("UserService", () => {
  ...
  describe("updateUser", () => {
    it("should throw error if user not found", async () => {
      ...
      await expect(
        service.updateUser("non-existent", { name: "New Name" }),
  ...
  describe("updateWorkingHours", () => {
    ...
    it("should require shiftId for SHIFT mode", async () => {
      await expect(
        service.updateWorkingHours("user-1", {
          workingHourMode: WorkingHourMode.SHIFT,
          startWorkTime: "08:00",
          endWorkTime: "17:00",
        }),
      ).rejects.toThrow("Shift wajib dipilih untuk mode Shift");
    });
