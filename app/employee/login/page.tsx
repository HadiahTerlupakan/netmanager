            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full py-4 min-h-[56px] md:min-h-[56px] input-neumorphic input-with-left-icon mobile-touch-target transition-all duration-300 ${
                    errors.identifier ? 'border-red-500 dark:border-red-400' : ''
                  }`}
                  required
                  aria-required="true"
                />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full py-4 min-h-[56px] md:min-h-[56px] input-neumorphic input-with-both-icons mobile-touch-target transition-all duration-300 ${
