            ...
            <div className="relative w-full h-40 bg-[#0d9488]/10 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 z-10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  >
                    <span
                      className={`size-1.5 rounded-full ${isAktif ? "bg-green-600 dark:bg-green-400" : "bg-red-600 dark:bg-red-400"}`}
                    ></span>
          ...
          <div className="rounded-2xl bg-white dark:bg-[#1a2632] shadow-sm p-5 border border-gray-100 dark:border-gray-800">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex justify-between items-start">
                ...
                <p className="text-gray-900 dark:text-white text-sm font-medium text-right">
                  {profile.idPelanggan}
                </p>
              </div>
              ...
              <div className="flex justify-between items-start">
                ...
                <p className="text-gray-900 dark:text-white text-sm font-medium text-right">
                  {getPeriodString(profile.jatuhTempo)}
                </p>
              </div>
              <div className="w-full h-px bg-gray-50 dark:bg-gray-700/50"></div>
              <div className="flex justify-between items-start">
              ...
              <div className="flex justify-between items-start">
                ...
                <p className="text-gray-900 dark:text-white text-sm font-medium text-right max-w-[50%]">
                  {profile.alamat}
                </p>
              </div>
            </div>
