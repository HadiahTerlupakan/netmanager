      ...
      <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden pb-20 max-w-md mx-auto bg-[#f6f7f8] dark:bg-[#101922]">
        ...
        <div className="flex flex-col gap-4 p-4">
              ...
              <div className="flex w-full grow flex-col gap-1 p-5 pt-2">
                ...
                <div className="flex items-center gap-3 justify-between">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[#111418] dark:text-white text-sm font-medium font-mono">
                      {ipAddress}
                    </span>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="bg-[#0d9488]/10 hover:bg-[#0d9488]/20 text-[#0d9488] dark:text-teal-400"
                  >
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="flex flex-col gap-2 rounded-xl p-4 bg-white dark:bg-[#1c2b3e] shadow-sm border border-[#dbe0e6] dark:border-gray-800">
              ...
              <div>
                <p className="text-[#111418] dark:text-white tracking-tight text-xl font-bold leading-tight">
                  {downloadSpeed}
                </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="ghost"
              className="group flex flex-col gap-3 h-auto items-start border border-[#dbe0e6] dark:border-gray-700 active:scale-95"
            >
          ...
          <div className="rounded-xl bg-teal-50 dark:bg-teal-900/10 p-4 border border-teal-100 dark:border-teal-900/30">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-[#111418] dark:text-white mb-1">
                  Tips Koneksi
                </p>
                <p className="text-sm text-[#617589] dark:text-gray-400 leading-relaxed">
                  Jika internet terasa lambat, cobalah mendekat ke router atau
        ...
        <div className="fixed bottom-0 left-0 right-0 border-t border-[#e5e7eb] dark:border-gray-800 bg-white dark:bg-[#1c2b3e] px-6 py-2 pb-5 z-50">
          <div className="flex justify-between items-end">
            <Link
              href="/dashboard"
              className="flex flex-col items-center gap-1 text-[#617589] dark:text-gray-400 hover:text-[#0d9488] transition-colors"
            >
            ...
            <Link
              href="/koneksi"
              className="flex flex-col items-center gap-1 text-[#0d9488] dark:text-[#0d9488]"
            >
