  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "WAITING_CUSTOMER":
        return "text-purple-500 bg-purple-500/10 ring-purple-500/20";
      case "RESOLVED":
        return "text-teal-500 bg-teal-500/10 ring-teal-500/20";
      case "CLOSED":
      ...
      <div className="relative flex flex-col w-full max-w-md mx-auto bg-white dark:bg-[#101622] min-h-screen shadow-2xl overflow-x-hidden">
        ...
        <div className="px-5 pt-4 pb-6">
          <h2 className="mb-4 text-3xl font-bold leading-tight text-slate-900 dark:text-white">
            Apa yang bisa <br />
            <span className="text-[#0d9488]">kami bantu?</span>
          </h2>
        ...
        <div className="px-5 mb-8">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link
              ...
              className="text-sm font-semibold text-[#0d9488] hover:text-teal-600"
            >
              Lihat Semua
            </Link>
          </div>
            ...
            <Link href={`/dukungan/${latestTicket.id}`}>
              <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-[#1c2333] p-5 shadow-sm ring-1 ring-slate-200 dark:ring-white/5 hover:ring-[#0d9488]/50 transition-all group cursor-pointer">
                ...
                <div className="absolute top-5 right-5">
                  <span
                    className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-bold ring-1 ring-inset ${getStatusColor(latestTicket.status)}`}
                  >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col pr-20">
                    ...
                    <h4 className="text-base font-bold leading-snug text-slate-900 dark:text-white line-clamp-1">
                      {latestTicket.subject}
                    </h4>
                    <p className="mt-2 text-xs text-slate-500 dark:text-slate-400 line-clamp-1">
                      Update:{" "}
                      {latestTicket.updatedAt &&
                      !isNaN(new Date(latestTicket.updatedAt).getTime())
                        ? formatDistanceToNow(
                            new Date(latestTicket.updatedAt),
          ...
          <div className="space-y-3">
            ...
            <details className="group overflow-hidden rounded-xl bg-white dark:bg-[#1c2333] shadow-sm ring-1 ring-slate-200 dark:ring-white/5">
              <summary className="flex w-full items-center justify-between p-4 text-left cursor-pointer">
                <span className="font-semibold text-slate-900 dark:text-white group-open:text-[#0d9488]">
              ...
              <div className="px-4 pb-4 pt-0 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                Anda dapat membayar tagihan melalui menu &quot;Tagihan&quot; di
                aplikasi ini, kemudian ikuti instruksi pembayaran via Transfer
                Bank atau QRIS.
              </div>
            </details>
            ...
            <details className="group overflow-hidden rounded-xl bg-white dark:bg-[#1c2333] shadow-sm ring-1 ring-slate-200 dark:ring-white/5">
              <summary className="flex w-full items-center justify-between p-4 text-left cursor-pointer">
                <span className="font-semibold text-slate-900 dark:text-white group-open:text-[#0d9488]">
                  Internet saya lambat, kenapa?
                </span>
                <MdExpandMore className="text-slate-400 group-open:rotate-180 transition-transform text-2xl" />
              </summary>
              <div className="px-4 pb-4 pt-0 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                Coba restart modem Anda dengan mematikannya selama 1 menit lalu
                nyalakan kembali. Jika masalah berlanjut, buat tiket bantuan
                teknis.
              </div>
            </details>
            ...
            <details className="group overflow-hidden rounded-xl bg-white dark:bg-[#1c2333] shadow-sm ring-1 ring-slate-200 dark:ring-white/5">
              ...
              <div className="px-4 pb-4 pt-0 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                Saat ini penggantian password wifi harus dilakukan melalui
                Admin. Silakan buat tiket dengan kategori &quot;Lainnya&quot;
        ...
        <div className="px-5 mb-24">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button
              variant="ghost"
              className="col-span-1 flex flex-col items-center justify-center gap-3 h-auto shadow-sm ring-1 ring-slate-200 dark:ring-white/5 hover:ring-[#0d9488]/50 group"
            >
            ...
            {/* Email */}
            <a
              href="mailto:support@netmanager.id"
              className="col-span-1 flex flex-col items-center justify-center gap-3 rounded-2xl bg-white dark:bg-[#1c2333] p-6 shadow-sm ring-1 ring-slate-200 dark:ring-white/5 transition-all active:scale-95 hover:ring-[#0d9488]/50 group"
            >
            ...
            <a
              ...
              className="col-span-2 flex items-center justify-between rounded-2xl bg-white dark:bg-[#1c2333] p-4 pl-6 shadow-sm ring-1 ring-slate-200 dark:ring-white/5 transition-all active:scale-95 hover:ring-[#0d9488]/50 group"
            >
