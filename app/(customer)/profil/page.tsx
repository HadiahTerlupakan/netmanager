    ...
    <div className="min-h-screen w-full bg-[#f6f7f8] dark:bg-[#101922] font-sans text-[#111418] dark:text-white transition-colors duration-200">
      <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto bg-[#f6f7f8] dark:bg-[#101922] pb-24">
        ...
        <div className="flex flex-col items-center pt-6 pb-6 px-4">
          <div className="relative mb-4">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC5CSzYuHLaqvmYa8lBplFGRvKgHiAtXRbTArIc14idsDgp7bVGWepxzP4MWldTWCMGUMCv1YjC0M4pClCyqMzAt4QaIsbXLm9m_a6LSIAoXSUlQtXb9tEUQTOMY-ifRod6e1UbS345BpgAo_j9q7tOJtzYHhu34j0uhdhuKx0TL_DS1axfgcAZfidBwMPPTF0K6L6Cmtqva9keLQahZbkSji_6M1B6PDJGeLvGkZzZTxsYp7OdM_k8HheOLRNSyXQZ8aNdnFU8Q_c")',
              }}
            ></div>
            <Button
              variant="ghost"
              size="icon-sm"
              className="absolute bottom-0 right-0 bg-[#0d9488] text-white shadow-lg border-2 border-white dark:border-gray-800"
            >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal text-center mt-1">
        ...
        <div className="px-4 mt-2">
          <h3 className="text-[#617589] dark:text-gray-400 text-xs font-semibold uppercase tracking-wider px-2 pb-2">
            Data Diri
          </h3>
            ...
            <div className="flex items-center gap-3 p-4 justify-between active:bg-gray-50 dark:active:bg-gray-700 transition-colors cursor-pointer border-b border-gray-100 dark:border-gray-700 last:border-0">
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="flex flex-col truncate">
                  <p className="text-[#111418] dark:text-white text-sm font-medium leading-normal truncate">
                    Email
                  </p>
          ...
          <div className="bg-white dark:bg-[#1e293b] rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div className="flex items-center gap-3 p-4 justify-between active:bg-gray-50 dark:active:bg-gray-700 transition-colors cursor-pointer border-b border-gray-100 dark:border-gray-700 last:border-0">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[#111418] dark:text-white text-sm font-medium leading-normal flex-1 truncate">
                  Ganti Password
                </p>
              </div>
              <div className="shrink-0 text-gray-400 dark:text-gray-500">
            ...
            {/* 2FA Toggle */}
            <div
              className="flex items-center gap-3 p-4 justify-between cursor-pointer"
              onClick={() => handleToggle("is2FAEnabled", is2FAEnabled)}
            >
              <div className="flex items-center gap-3">
                <div className="text-[#0d9488] flex items-center justify-center rounded-lg bg-[#0d9488]/10 shrink-0 size-9">
              ...
              <div className="shrink-0 relative inline-flex items-center cursor-pointer">
                <div
                  className={`w-11 h-6 rounded-full peer transition-colors ${is2FAEnabled ? "bg-[#0d9488]" : "bg-gray-200 dark:bg-gray-600"}`}
                >
                  <div
                    className={`absolute top-[2px] left-[2px] bg-white rounded-full h-5 w-5 shadow-sm transition-transform ${is2FAEnabled ? "translate-x-full border-white" : "translate-x-0"}`}
                  ></div>
                </div>
              </div>
            </div>
        ...
        <div className="px-4 mt-6">
          ...
          <div className="bg-white dark:bg-[#1e293b] rounded-xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div
              className="flex items-center gap-3 p-4 justify-between border-b border-gray-100 dark:border-gray-700 cursor-pointer"
              onClick={() =>
                handleToggle("isBillNotifEnabled", isBillNotifEnabled)
              }
            >
              <div className="flex items-center gap-3">
                <div className="text-[#0d9488] flex items-center justify-center rounded-lg bg-[#0d9488]/10 shrink-0 size-9">
              ...
              <div className="shrink-0 relative inline-flex items-center cursor-pointer">
                <div
                  className={`w-11 h-6 rounded-full peer transition-colors ${isBillNotifEnabled ? "bg-[#0d9488]" : "bg-gray-200 dark:bg-gray-600"}`}
                >
                  <div
                    className={`absolute top-[2px] left-[2px] bg-white rounded-full h-5 w-5 shadow-sm transition-transform ${isBillNotifEnabled ? "translate-x-full border-white" : "translate-x-0"}`}
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div
              className="flex items-center gap-3 p-4 justify-between border-b border-gray-100 dark:border-gray-700 cursor-pointer"
              onClick={() => handleToggle("isPromoEnabled", isPromoEnabled)}
            >
              <div className="flex items-center gap-3">
                <div className="text-[#0d9488] flex items-center justify-center rounded-lg bg-[#0d9488]/10 shrink-0 size-9">
              ...
              <div className="shrink-0 relative inline-flex items-center cursor-pointer">
                <div
                  className={`w-11 h-6 rounded-full peer transition-colors ${isPromoEnabled ? "bg-[#0d9488]" : "bg-gray-200 dark:bg-gray-600"}`}
                >
                  <div
                    className={`absolute top-[2px] left-[2px] bg-white rounded-full h-5 w-5 shadow-sm transition-transform ${isPromoEnabled ? "translate-x-full border-white" : "translate-x-0"}`}
                  ></div>
                </div>
              </div>
            </div>
        ...
        <div className="px-4 mt-8 flex flex-col gap-4">
          ...
          <p className="text-center text-xs text-gray-400 dark:text-gray-600 font-medium">
            Versi Aplikasi 2.4.0 (Build 302)
          </p>
        </div>
