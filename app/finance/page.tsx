  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20 md:pb-8">
      ...
      <main className="px-4 py-4 md:px-6 lg:px-8">
        ...
        {/* Welcome Card */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md mb-4 p-4">
          <div className="flex items-center justify-between">
            <div>
        ...
        {/* Financial Overview */}
        <div className="bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl shadow-lg mb-4 p-5 text-white">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">Ringkasan Keuangan Bulan Ini</h3>
            <HiOutlineChartBar className="w-6 h-6" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <p className="text-xs text-white/80 mb-1">Total Tagihan</p>
              <p className="text-2xl font-bold">{formatRupiah(stats?.financial?.totalBulanIni || 0)}</p>
            </div>
            <div>
              <p className="text-xs text-white/80 mb-1">Sudah Lunas</p>
              <p className="text-2xl font-bold">{stats?.financial?.lunasBulanIni || 0} tagihan</p>
            </div>
            <div>
              <p className="text-xs text-white/80 mb-1">Belum Lunas</p>
              <p className="text-2xl font-bold">{stats?.financial?.belumLunasBulanIni || 0} tagihan</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Kelola Tagihan</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Lihat dan kelola semua tagihan</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Laporan Keuangan</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Lihat laporan keuangan detail</p>
              </div>
            </Link>
          </div>
        </div>
