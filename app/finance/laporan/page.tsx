...
import { HiBars3, HiOutlineChartBar } from 'react-icons/hi2'
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20 md:pb-8">
      ...
      <main className="px-4 py-4 md:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 text-center">
          <HiOutlineChartBar className="w-16 h-16 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
            Halaman Laporan Keuangan
          </h2>
          <p className="text-gray-500 dark:text-gray-400">
            Fitur laporan keuangan detail sedang dalam pengembangan
          </p>
        </div>
      </main>
    </div>
