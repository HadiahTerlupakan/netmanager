...
import { HiOutlineUser, HiOutlineLockClosed, HiArrowRight } from 'react-icons/hi2'
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-neutral-900 dark:to-black min-h-screen w-full">
            <div className="w-full max-w-sm space-y-8 animate-in fade-in zoom-in-95 duration-500">
                <div className="flex flex-col items-center text-center space-y-2">
                    ...
                    <h1 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Investor Portal</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Masuk untuk melihat performa investasi Anda</p>
                </div>

                <form onSubmit={handleSubmit} className="bg-white dark:bg-neutral-800/50 p-6 sm:p-8 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-neutral-800 space-y-6">
                ...
                <p className="text-center text-xs text-gray-500 pt-4">
                    Jika Anda mengalami kendala saat login,<br />silahkan hubungi administrator.
                </p>
            </div>
        </div>
    )
