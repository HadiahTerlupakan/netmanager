...
/** GET /api/admin/salary/components/[id] — Get component detail */
...
/** PUT /api/admin/salary/components/[id] — Update component */
...
/** DELETE /api/admin/salary/components/[id] — Delete component */
