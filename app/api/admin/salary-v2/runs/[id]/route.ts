...
/** GET /api/admin/salary-v2/runs/[id] — Get payroll run detail */
...
/** PUT /api/admin/salary-v2/runs/[id] — Update payroll run */
...
/** DELETE /api/admin/salary-v2/runs/[id] — Delete payroll run */
