...
export const POST = createHandler({ auth: true }, async (req, ctx) => {
  ...
  interface RabProjectWithItems {
    ...
    investorProfitShareMode: import("@prisma/client").RabInvestorProfitShareMode;
  ...
  // 3. Serialize BigInt
  const duplicatedProjectTyped =
    duplicatedProject as unknown as RabProjectWithItems;
  const serialized = {
