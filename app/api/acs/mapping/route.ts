...
export const GET = createHandler({ auth: true, permissions: ['acs:read'] }, async () => {
  try {
    ...
    return ApiErrors.internalError('Gagal mengambil data mapping ACS')
  }
})
