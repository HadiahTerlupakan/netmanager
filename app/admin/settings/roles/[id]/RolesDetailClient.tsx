                    ...
                    <div className={formData.isSuperAdmin ? 'opacity-50 pointer-events-none' : ''}>
                        ...
                        <label className="flex items-start gap-3 p-4 border border-emerald-200 bg-emerald-50 dark:bg-emerald-900/10 dark:border-emerald-800 rounded-xl hover:bg-emerald-100 dark:hover:bg-emerald-900/20 cursor-pointer transition-colors mt-4">
                            <input
                                ...
                                onChange={e => setFormData({ ...formData, canApproveRab: e.target.checked })}
                                className="w-5 h-5 text-emerald-600 rounded focus:ring-emerald-500 border-gray-300 mt-0.5"
                            />
                            <div>
                                <span className="block font-medium text-emerald-900 dark:text-emerald-300">Persetujuan RAB (Manager)</span>
                                <span className="text-sm text-emerald-700 dark:text-emerald-400">
                                    Aktifkan ini untuk memberikan wewenang pada role guna menyetujui, mencetak Tanda Tangan, dan mengubah status dokumen Pengajuan RAB dari <strong>DRAFT</strong> menuju <strong>APPROVED</strong>.
                                </span>
                            </div>
                        </label>
                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-wrap gap-1 mt-3">
                                                    {template.tags.map(tag => (
                                                        <span
                                                            key={tag}
                                                            className={`text-[10px] px-1.5 py-0.5 rounded font-medium ${isSelected ? `${colors.tagBg} ${colors.tagText}` : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'
                                                                }`}
                                                        >
                                                            {tag}
                                                        </span>
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex bg-gray-100 dark:bg-gray-700 p-1 rounded-lg">
                                <button
                                    ...
                                    className={`flex-1 py-1.5 px-3 text-sm font-medium rounded-md transition-all ${!formData.accessAdminPanel
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-1.5 px-3 text-sm font-medium rounded-md transition-all ${!formData.accessEmployeePanel
                                            ? 'text-gray-300 dark:text-gray-600 cursor-not-allowed'
                                            : activeTab === 'employee'
                                                ? 'bg-white dark:bg-gray-600 text-gray-800 dark:text-white shadow-sm'
                                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                                                            ...
                                                            <div key={resource} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-md transition-shadow flex flex-col">
                                                                ...
                                                                <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className={`text-xs px-2.5 py-1 rounded-md font-medium transition-colors ${isAllSelected
                                                                                ...
                                                                                {['read', 'create', 'update', 'delete'].map(action => {
                                                                                    ...
                                                                                    return (
                                                                                        <button
                                                                                            ...
                                                                                            className={`flex flex-col items-center justify-center py-2 px-1 rounded-lg border transition-all h-full ${isSelected
                                                                                ...
                                                                                {specialActions.map(action => {
                                                                                    ...
                                                                                    return (
                                                                                        <button
                                                                                            ...
                                                                                            className={`px-3 py-1.5 text-xs font-medium rounded-full border transition-all flex items-center gap-1.5 ${isSelected
                                                                        ...
                                                                        <div className="mt-auto pt-3 border-t border-gray-100 dark:border-gray-700/50">
                                                                            ...
                                                                            <div className="space-y-2">
                                                                                {scopeActions.map(action => {
                                                                                    ...
                                                                                    return (
                                                                                        <label key={action} className={`flex items-center justify-between p-2 rounded-lg border cursor-pointer transition-all ${isSelected
