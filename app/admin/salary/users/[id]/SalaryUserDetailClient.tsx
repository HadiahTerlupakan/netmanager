...
export default function SalaryUserDetailClient() {
  ...
  const avatarBg =
    avatarColor.replace("bg-", "text-").replace("text-", "bg-").split(" ")[0] ??
    "";
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            Konfigurasi gaji dan riwayat slip
          </p>
        </div>
      </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="text-green-600 font-medium mt-1">
                      {formatCurrency(user.woIncentiveRate)}
                    </div>
                  </div>
                  <div>
                    <label className="text-xs text-gray-500 font-medium">
                    ...
                    <div className="text-red-500 font-medium mt-1">
                      {formatCurrency(user.lateDeductionRate)}
                    </div>
                  </div>
                  <div>
                    <label className="text-xs text-gray-500 font-medium">
                    ...
                    <div className="text-red-500 font-medium mt-1">
                      {formatCurrency(user.absentDeductionRate)}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-gray-800 space-y-3">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-medium text-indigo-600 dark:text-indigo-400">
                    {user.ptkpStatus || "TK_0"}
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-500">BPJS Kesehatan</span>
                  <span
                    className={`px-2 py-0.5 rounded text-[10px] font-bold ${user.bpjsKesehatan ? "bg-indigo-100 text-indigo-700" : "bg-gray-100 text-gray-500"}`}
                  >
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded text-[10px] font-bold ${user.bpjsKetenagakerjaan ? "bg-indigo-100 text-indigo-700" : "bg-gray-100 text-gray-500"}`}
                  >
          ...
          <Card className="border-0 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800">
            ...
            <CardContent className="p-8 text-center text-gray-500">
              ...
              <p className="text-sm mt-2 text-gray-400">
                Slip gaji akan muncul di sini setelah payroll dijalankan.
              </p>
            </CardContent>
          </Card>
        </div>
