...
export default function AddAccountModal({
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case "BANK":
        return <HiOutlineBuildingLibrary className="w-5 h-5 text-blue-500" />;
      case "CASH":
        return <HiOutlineBanknotes className="w-5 h-5 text-green-500" />;
      case "EWALLET":
        return <HiOutlineCreditCard className="w-5 h-5 text-purple-500" />;
      default:
        return <HiOutlineWallet className="w-5 h-5 text-gray-500" />;
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-2 border-t border-gray-100 dark:border-gray-700/50 mt-2">
            ...
            <p className="text-xs text-blue-600 dark:text-blue-400 mt-2 flex items-start gap-1">
              ...
              <span>
                Sebaiknya biarkan 0 jika Anda ingin mencatat saldo awal melalui
                transaksi pemasukan agar tercatat di histori mutasi.
              </span>
            </p>
          </div>
