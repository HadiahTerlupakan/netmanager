...
export default function UnpaidBillsClient({
  initialData,
  accounts,
  hideHeader = false,
  ...
  const totalUnpaid = filteredPos.reduce((sum, po) => {
    const paid = (po.transactions || []).reduce(
      ...
      {!hideHeader && (
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Daftar tagihan pembelian yang perlu dibayar ke supplier (Account
                Payable).
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Total Hutang Card */}
            <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/30 dark:to-orange-900/30 rounded-xl p-5 border border-red-100 dark:border-red-800 shadow-sm relative overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              ...
              {filteredPos.map((po) => {
                const paidAmount = (po.transactions || []).reduce(
                  (acc: number, curr) => acc + curr.amount,
                  0,
                );
                const targetAmount =
                  po.grandTotal > 0 ? po.grandTotal : po.totalAmount;
      ...
      >
        ...
        {selectedPo && (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 p-5 rounded-xl border border-blue-100 dark:border-blue-800 shadow-sm relative overflow-hidden">
              ...
              <div className="flex justify-between items-start relative z-10">
                <div>
                  <div className="text-xs font-semibold text-blue-600 dark:text-blue-300 uppercase tracking-wider mb-1">
                    Nomor PO
                  </div>
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-700 mt-2">
              ...
              <Button loading={loading} onClick={handlePay} className="gap-2">
