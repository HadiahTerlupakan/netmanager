...
export function ClientComponent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Untuk edit, hanya cek error jika ID berubah
    if (idPelangganError) {
  ...
  // Validasi ID Pelanggan dengan debounce (hanya jika ID berubah)
  useEffect(() => {
    ...
    // Jika ID sama dengan original, tidak perlu cek duplikat
    if (idValue === originalIdPelanggan) {
      setIdPelangganError(null)
      return
    }

    // Cek duplikat dengan debounce hanya jika ID berubah
    if (!idValue) {
      setIdPelangganError(null)
      return
    }
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          maxLength={8}
                          pattern="[0-9]{8}"
                          className={`w-full rounded-lg border ${idPelangganError
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
                >
                  {submitting ? (
                    <>
