...
export function ClientComponent() {
    ...
    return (
        <div className="w-full space-y-5">
            <div className="mb-4">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Pengaturan Captcha & Keamanan</h2>
                <p className="text-sm text-gray-500">Konfigurasi Cloudflare Turnstile untuk mencegah spam pada formulir pendaftaran.</p>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <div className="flex items-center gap-3">
                                <HiShieldCheck className={`w-8 h-8 ${settings.enabled ? 'text-green-500' : 'text-gray-400'}`} />
                                <div>
                                    <h3 className="text-sm font-medium text-gray-900 dark:text-white">Aktifkan Captcha</h3>
                                    <p className="text-xs text-gray-500">Formulir pendaftaran akan dilindungi oleh Cloudflare Turnstile.</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Dapatkan key ini dari dashboard <a href="https://dash.cloudflare.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">Cloudflare Turnstile</a>.
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        >
                            {saving ? <HiArrowPath className="animate-spin" /> : <HiCheckCircle />}
                            Simpan Pengaturan
                        </button>
                    </form>
                )}
