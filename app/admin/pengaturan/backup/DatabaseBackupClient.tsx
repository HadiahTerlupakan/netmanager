            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg mb-5">
                    ...
                    <p className="text-xs text-blue-800 dark:text-blue-400 leading-relaxed">
                        Fitur ini akan mengecek seluruh data yang tidak memiliki <strong>ID Tenant</strong> dan menghubungkannya dengan tenant utama. Jalankan rutin <strong>satu kali setelah berhasil mengimport database legacy</strong>.
                    </p>
                </div>
