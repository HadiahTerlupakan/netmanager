...
export default function SalesListClient() {
  ...
  const [newSchema, setNewSchema] = useState<"MONTHLY_RESET" | "ACCUMULATED">(
    "MONTHLY_RESET",
  );
  ...
  const handleSaveTarget = async () => {
    ...
    try {
      ...
      clientLogger.error("Error saving target:", error);
  ...
  const emptyState = (
    <div className="flex flex-col items-center py-2">
      ...
      <p className="text-gray-500 dark:text-gray-400">
        Belum ada user yang ditandai sebagai Sales.
      </p>
      <p className="text-sm text-gray-400 mt-1">
        Buka menu <b>Users</b>, edit user, dan aktifkan &quot;Fitur Sales&quot;.
      </p>
    </div>
  );
      ...
      >
        ...
        <div className="mb-4">
          ...
          <select
            value={newSchema}
            onChange={(e) =>
              setNewSchema(e.target.value as "MONTHLY_RESET" | "ACCUMULATED")
            }
