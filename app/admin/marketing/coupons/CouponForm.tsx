            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 gap-6">
                        {/* Code & Description */}
                        <div>
                            <label className="block text-sm font-medium mb-2">Kode Kupon</label>
                            <input
                                type="text"
                                required
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium mb-2">Min. Transaksi (Rp)</label>
                                <input
                                    type="number"
                                    className="w-full px-4 py-2 rounded-lg border dark:bg-gray-700 dark:border-gray-600"
                                    placeholder="0"
                                    value={formData.minTransaction}
                                    onChange={e => setFormData({ ...formData, minTransaction: e.target.value })}
                                />
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-2">Kuota (0 = Tak Terbatas)</label>
                                <input
                                    type="number"
                                    className="w-full px-4 py-2 rounded-lg border dark:bg-gray-700 dark:border-gray-600"
                                    placeholder="0"
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <label htmlFor="isActive" className="text-sm font-medium">Langsung Aktifkan</label>
                        </div>
                    </div>
