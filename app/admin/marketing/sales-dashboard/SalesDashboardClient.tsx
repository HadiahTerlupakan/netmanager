  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const res = await fetch(
        `/api/admin/marketing/sales-dashboard?${params.toString()}`,
      );
      if (res.ok) {
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">
                      {user.approved} canvasing • {user.points} poin
                    </p>
                  </div>
              ...
              data.topSites.map((site, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">
                      {site.name} • {site.salesCount} sales
                    </p>
                  </div>
                  <div className="text-right">
          ...
          {data.weeklyTrend.map((trend) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  height: `${(trend.count / maxTrend) * 100}%`,
                  minHeight: trend.count > 0 ? "8px" : "4px",
                }}
              />
...
function StatCard({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
      <div
        className={`w-10 h-10 rounded-lg flex items-center justify-center mb-2 ${colorClasses[color]}`}
      >
