import { HiOutlineUsers, HiOutlineCheckCircle, HiOutlineXCircle } from 'react-icons/hi2'
...
export default function UserStats({ totalUsers, activeUsers, inactiveUsers }: UserStatsProps) {
    return (
