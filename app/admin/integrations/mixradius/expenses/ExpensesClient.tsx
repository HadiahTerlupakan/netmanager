...
export default function ExpensesClient() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const selectedOption = sites.find(
    ...
    const csvContent = buildExpenseCsvContent(
      rowsToExport.map((item) => {
        ...
        const siteOrGroup = item.mixRadiusGroupId
          ? sites.find((s) => s.id === item.mixRadiusGroupId)?.name ||
            item.site?.name ||
            "Umum"
          : item.site?.name || "Umum";
            ...
            <ResponsiveTable
              ...
              columns={[
                ...
                },
                {
                  ...
                  header: "Site / Group",
                  render: (item) => {
                    const name = item.mixRadiusGroupId
                      ? sites.find((s) => s.id === item.mixRadiusGroupId)
                          ?.name || item.site?.name
                      : item.site?.name;
                    return name ? (
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                mixRadiusGroupId: e.target.value,
                              })
                            }
