    ...
    <div className="p-6 space-y-6 min-h-screen bg-gray-50/50 dark:bg-[#0b1120]">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Detail mutasi per akun untuk periode tertentu
        </p>
      </div>
      ...
      {report && (
        <>
          {/* Account Info */}
          <div className="bg-white dark:bg-[#1e293b] p-4 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-wrap items-center gap-4">
