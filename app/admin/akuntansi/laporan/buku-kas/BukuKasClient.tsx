...
export function BukuKasClient() {
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen bg-gray-50/50 dark:bg-[#0b1120]">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Mutasi kas dan bank per akun dalam periode tertentu
          </p>
        </div>
      </div>
      ...
      {report && (
        <>
          <div className="bg-white dark:bg-[#1e293b] p-5 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm inline-flex gap-8">
            <div>
