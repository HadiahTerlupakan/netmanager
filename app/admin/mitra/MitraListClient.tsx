...
export default function MitraListClient() {
    ...
    try {
      const res = await fetch("/api/admin/mitra", {
        ...
        body: JSON.stringify({
          ...
          mitraRateWoPsb: form.mitraRateWoPsb
            ? parseFloat(form.mitraRateWoPsb)
            : undefined,
          mitraRateWoMaintenance: form.mitraRateWoMaintenance
            ? parseFloat(form.mitraRateWoMaintenance)
            : undefined,
          mitraRateCanvasing: form.mitraRateCanvasing
            ? parseFloat(form.mitraRateCanvasing)
            : undefined,
          minWithdrawal: form.minWithdrawal
            ? parseFloat(form.minWithdrawal)
            : undefined,
          targetHarian: form.targetHarian
            ? parseInt(form.targetHarian, 10)
            : undefined,
          garansiHari: form.garansiHari
            ? parseInt(form.garansiHari, 10)
            : undefined,
          slaGaransiJam: form.slaGaransiJam
            ? parseInt(form.slaGaransiJam, 10)
            : undefined,
          penaltyPsb: form.penaltyPsb ? parseFloat(form.penaltyPsb) : undefined,
          penaltyMaintenance: form.penaltyMaintenance
            ? parseFloat(form.penaltyMaintenance)
            : undefined,
          mitraRateFeePelanggan: form.mitraRateFeePelanggan
            ? parseFloat(form.mitraRateFeePelanggan)
            : undefined,
          ...
          latitudeRumah: form.latitudeRumah
            ? parseFloat(form.latitudeRumah)
            : undefined,
          longitudeRumah: form.longitudeRumah
            ? parseFloat(form.longitudeRumah)
            : undefined,
  ...
  const openEditModal = (mitra: Mitra) => {
    ...
    setForm({
      ...
      targetHarian:
        (mitra as Mitra & { targetHarian?: number }).targetHarian?.toString() ||
        "",
      ...
      mitraRateFeePelanggan:
        (
          mitra as Mitra & { mitraRateFeePelanggan?: number }
        ).mitraRateFeePelanggan?.toString() || "",
      enableFeePelanggan: mitra.enableFeePelanggan || false,
      mixradiusOwnerNames:
        (mitra as Mitra & { mixradiusOwnerNames?: string[] })
          .mixradiusOwnerNames || [],
      nik: mitra.nik || "",
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, latitudeRumah: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, longitudeRumah: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div className="md:col-span-2">
        <div className="border-t border-gray-200 dark:border-gray-700 my-2 pt-3">
          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            Dokumen Pendukung (Maksimal 5MB/file)
          </h4>
        </div>
      </div>
      {[
          ...
          <div className="flex items-center gap-3">
            {form[field as keyof typeof form] && (
              <>
                ...
                <img
                  src={String(form[field as keyof typeof form])}
                  alt={label}
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) =>
            setForm((f) => ({
              ...f,
              employeeType: e.target.value as "MITRA_TEKNISI" | "MITRA_SALES",
            }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
        >
        ...
        <>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, mitraRateWoPsb: e.target.value }))
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({
                  ...f,
                  mitraRateWoMaintenance: e.target.value,
                }))
              }
        ...
        <>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, mitraRateCanvasing: e.target.value }))
              }
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              placeholder="25000"
            />
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({
                      ...f,
                      enableFeePelanggan: e.target.checked,
                    }))
                  }
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({
                      ...f,
                      mitraRateFeePelanggan: e.target.value,
                    }))
                  }
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              ...
              <div className="md:col-span-2 mt-2">
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Pilih Owners MixRadius ({form.mixradiusOwnerNames.length}{" "}
                    dipilih)
                  </label>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, minWithdrawal: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          placeholder="Cth: 50000"
        />
      ...
      {form.employeeType === "MITRA_SALES" && (
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setForm((f) => ({ ...f, targetHarian: e.target.value }))
            }
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, garansiHari: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, slaGaransiJam: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, penaltyPsb: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, penaltyMaintenance: e.target.value }))
          }
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            ...
            {totalPages > 1 && (
              <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-3">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  {Math.min(page * 20, total)} dari {total} mitra
                </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Mitra ini akan dinonaktifkan dan tidak bisa login. Data tidak
            dihapus permanen.
          </p>
        </div>
        <ModalFooter>
