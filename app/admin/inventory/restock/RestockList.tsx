...
export default function RestockPage() {
  ...
  const handleReorder = async () => {
    ...
    try {
      ...
      const response = await postWithAuth('/api/inventory/restock/requests', {
            ...
            <div className="flex flex-col gap-2">
              ...
              {canUpdate && (
                <button
                  ...
                  className="inline-flex justify-center items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                   <span className="text-white">Buat PR</span>
                </button>
              )}
            </div>
          ) : (
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-3">
            ...
            >
              <svg aria-hidden="true" className="w-4 h-4 mr-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mb-6 bg-white dark:bg-gray-800 shadow rounded-lg p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="filterGudang" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Filter Gudang
            </label>
            <select
              id="filterGudang"
          ...
          <div>
            <label htmlFor="filterUrgency" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Filter Urgency
            </label>
            <select
              id="filterUrgency"
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            <button
              ...
              disabled={processingOrder}
              className={`px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-400 focus:outline-none flex items-center ${processingOrder ? 'opacity-75 cursor-not-allowed' : ''}`}
            >
              {processingOrder && (
                <svg aria-hidden="true" className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
