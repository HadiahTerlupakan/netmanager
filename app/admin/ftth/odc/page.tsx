      ...
      <div className="overflow-x-auto rounded-md border border-gray-200 dark:border-gray-800">
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-950">
            {odcs.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400">Belum ada data ODC.</td>
              </tr>
            ) : (
              odcs.map((o) => (
                <tr key={o.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/50">
                  ...
                  <td className="px-4 py-3 text-right"><OdcActions id={o.id} status={o.status} /></td>
                </tr>
              ))
            )}
          </tbody>
