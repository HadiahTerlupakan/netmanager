...
export function ClientComponent() {
  ...
  const rekapColumns: Column<EmployeeSummary>[] = [
    ...
    },
    {
      ...
      sortable: true,
      render: (item) => (
        <span className="text-purple-600">{item.lemburJam}</span>
      ),
    },
    {
      key: "totalJamKerja",
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-4 border-b border-gray-200 dark:border-gray-700">
        <Button
          ...
          className={`px-4 py-2 font-medium text-sm transition-colors rounded-none border-b-2 ${
            activeTab === "dashboard"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 dark:text-white">
                    {data.attendance.summary.totalAttendance}
                  </p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border-l-4 border-teal-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 dark:text-white">
                    {formatDuration(
                      data.attendance.summary.avgDurationMinutes || 0,
                    )}
                  </p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border-l-4 border-yellow-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 dark:text-white">
                    {data.attendance.summary.lateCount}
                  </p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border-l-4 border-red-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 dark:text-white">
                    {data.attendance.summary.alphaCount}
                  </p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border-l-4 border-purple-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 dark:text-white">
                    {data.overtime.summary.totalRequests}{" "}
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border-l-4 border-green-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800 dark:text-white">
                    {data.overtime.summary.avgDuration}{" "}
                    <span className="text-sm font-normal text-gray-400">
                      Menit
                    </span>
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              ...
              <div className="h-64">
                <Line
                  data={{
                    labels: data.attendance.trends.map(
                      (t: AttendanceTrend) => t.date,
                    ),
                    datasets: [
                      {
                        label: "Hadir",
                        data: data.attendance.trends.map(
                          (t: AttendanceTrend) => t.present,
                        ),
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              ...
              <div className="h-64">
                <Bar
                  data={{
                    labels: data.overtime.trends.map(
                      (t: OvertimeTrend) => t.date,
                    ),
                    datasets: [
                      {
                        label: "Durasi Lembur (Menit)",
                        data: data.overtime.trends.map(
                          (t: OvertimeTrend) => t.duration,
                        ),
              ...
              <ResponsiveTable<DepartmentStat>
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    align: "center",
                    render: (item) => (
                      <span className="text-yellow-600">{item.late}</span>
                    ),
                  },
                  {
                    key: "overtime",
                    ...
                    align: "center",
                    render: (item) => {
                      const ot = data.overtime.byDepartment.find(
                        (o: DepartmentStat) => o.name === item.name,
                      );
                      return (
                        <span className="text-purple-600 font-medium">
                          {ot?.duration ? (ot.duration / 60).toFixed(1) : "0.0"}
                        </span>
                      );
                    },
                  },
              ...
              <ResponsiveTable<SiteStat>
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    align: "center",
                    render: (item) => {
                      const ot = data.overtime.bySite.find(
                        (o: SiteStat) => o.name === item.name,
                      );
                      return (
                        <span className="text-purple-600 font-medium">
                          {ot?.duration ? (ot.duration / 60).toFixed(1) : "0.0"}
          ...
          <ResponsiveTable<EmployeeSummary>
            data={(() => {
              ...
              filtered = [...filtered].sort(
                (a: EmployeeSummary, b: EmployeeSummary) => {
                  const aVal =
