...
export default function ShiftClient() {
    ...
    const openCreateModal = () => {
        ...
        setFormData({ name: '', code: '', startTime: '08:00', endTime: '17:00', description: '' })
        setError('')
        setShowModal(true)
    }
    ...
    const columns: Column<Shift>[] = [
        {
            ...
            render: (shift) => (
                <div>
                    ...
                    {shift.code && <div className="text-xs text-gray-500">{shift.code}</div>}
                </div>
            )
        },
        {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Manajemen Shift</h1>
