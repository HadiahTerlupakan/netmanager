...
import type { Bandwidth, DurationUnit, HargaFormData, HargaStatus, ProfilePPP, Site } from '@/app/admin/paket/harga/lib/hargaTypes'
...
type HargaFormModalProps = {
  ...
  onFieldChange: <K extends keyof HargaFormData>(field: K, value: HargaFormData[K]) => void
}
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(event) => onFieldChange('profilePPPId', event.target.value)}
            className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
          >
        ...
        {pppConnectionMode === 'RADIUS' && (
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bandwidth</label>
            <select
              value={formData.bandwidthId || ''}
              onChange={(event) => onFieldChange('bandwidthId', event.target.value || null)}
              className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
            >
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Jika dipilih, rate limit akan mengikuti bandwidth ini. Jika kosong, akan menggunakan setting di Profile PPP.</p>
          </div>
        )}
        ...
        <div>
          ...
          <select
            ...
            onChange={(event) => onFieldChange('siteId', event.target.value || null)}
            className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
          >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(event) => onFieldChange('harga', event.target.value ? parseInt(event.target.value, 10) : 0)}
              className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
              placeholder="300000"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <select
                ...
                onChange={(event) => onFieldChange('durasiUnit', event.target.value as DurationUnit)}
              ...
              >
                {DURATION_OPTIONS.map((unit) => (
                  <option key={unit} value={unit}>{unit === 'JAM' ? 'Jam' : unit === 'HARI' ? 'Hari' : unit === 'BULAN' ? 'Bulan' : 'Tahun'}</option>
                ))}
              </select>
            </div>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <input
              ...
              onChange={(event) => onFieldChange('usePPN', event.target.checked)}
              className="rounded border-gray-300 dark:border-gray-700"
            />
            <label htmlFor="harga-use-ppn" className="text-sm font-medium text-gray-700 dark:text-gray-300">Gunakan PPN</label>
          </div>
          {formData.usePPN && (
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <input
                ...
                onChange={(event) => onFieldChange('ppnPercentage', event.target.value ? parseFloat(event.target.value) : null)}
                className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
                placeholder="11"
              />
            </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <input
              ...
              onChange={(event) => onFieldChange('useDiscount', event.target.checked)}
              className="rounded border-gray-300 dark:border-gray-700"
            />
            <label htmlFor="harga-use-discount" className="text-sm font-medium text-gray-700 dark:text-gray-300">Gunakan Diskon</label>
          </div>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(event) => onFieldChange('discountType', event.target.value as 'FIXED' | 'PERCENT')}
              ...
              {formData.discountType && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(event) => onFieldChange('discountValue', event.target.value ? parseFloat(event.target.value) : null)}
                    className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      onChange={(event) => onFieldChange('discountDuration', event.target.value ? parseInt(event.target.value, 10) : null)}
                      className="flex-1 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
                      placeholder="30"
                    />
                    <select
                      ...
                      onChange={(event) => onFieldChange('discountDurationUnit', event.target.value as DurationUnit | null)}
                      className="rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
                    >
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="rounded border-gray-300 dark:border-gray-700"
          />
          <label htmlFor="harga-featured" className="text-sm text-gray-700 dark:text-gray-300">Paket Unggulan</label>
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={(event) => onFieldChange('status', event.target.value as HargaStatus)}
            className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
          >
