...
type BandwidthFormModalProps = {
  ...
  onFieldChange: <K extends keyof BandwidthFormData>(
    field: K,
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <select
              value={downloadUnit}
              onChange={(event) =>
                onDownloadUnitChange(event.target.value as BandwidthUnit)
              }
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <select
              value={uploadUnit}
              onChange={(event) =>
                onUploadUnitChange(event.target.value as BandwidthUnit)
              }
              className="w-20 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
            >
              {UNIT_OPTIONS.map((unit) => (
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 mb-4">
          <p className="text-sm text-blue-800 dark:text-blue-300">
            <strong>Format Queue MikroTik:</strong> Pengaturan ini akan
            digunakan untuk konfigurasi Simple Queue di MikroTik RouterOS.
        ...
        <RatePairSection
          ...
          onDownloadValueChange={(value) =>
            onFieldChange("maxLimitDownloadValue", value)
          }
          onDownloadUnitChange={(value) =>
            onFieldChange("maxLimitDownloadUnit", value)
          }
          onUploadValueChange={(value) =>
            onFieldChange("maxLimitUploadValue", value)
          }
          onUploadUnitChange={(value) =>
            onFieldChange("maxLimitUploadUnit", value)
          }
        ...
        <RatePairSection
          ...
          onDownloadValueChange={(value) =>
            onFieldChange("burstLimitDownloadValue", value)
          }
          onDownloadUnitChange={(value) =>
            onFieldChange("burstLimitDownloadUnit", value)
          }
          onUploadValueChange={(value) =>
            onFieldChange("burstLimitUploadValue", value)
          }
          onUploadUnitChange={(value) =>
            onFieldChange("burstLimitUploadUnit", value)
          }
        ...
        <RatePairSection
          ...
          onDownloadValueChange={(value) =>
            onFieldChange("minLimitDownloadValue", value)
          }
          onDownloadUnitChange={(value) =>
            onFieldChange("minLimitDownloadUnit", value)
          }
          onUploadValueChange={(value) =>
            onFieldChange("minLimitUploadValue", value)
          }
          onUploadUnitChange={(value) =>
            onFieldChange("minLimitUploadUnit", value)
          }
        ...
        <RatePairSection
          ...
          onDownloadValueChange={(value) =>
            onFieldChange("burstThresholdDownloadValue", value)
          }
          onDownloadUnitChange={(value) =>
            onFieldChange("burstThresholdDownloadUnit", value)
          }
          onUploadValueChange={(value) =>
            onFieldChange("burstThresholdUploadValue", value)
          }
          onUploadUnitChange={(value) =>
            onFieldChange("burstThresholdUploadUnit", value)
          }
        ...
        <div>
          ...
          <select
            ...
            onChange={(event) =>
              onFieldChange("status", event.target.value as BandwidthStatus)
            }
            className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
          >
