...
export default function RegistrationPage() {
    ...
    useEffect(() => {
        if (captchaEnabled && siteKey && window.turnstile && turnstileContainerRef.current) {
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#101922] font-sans text-slate-900 dark:text-white pb-20">
            <div className="max-w-md mx-auto min-h-screen bg-white dark:bg-[#101922] shadow-2xl relative">
                ...
                <header className="bg-white dark:bg-[#101922] p-6 sticky top-0 z-20 border-b border-slate-100 dark:border-slate-800 flex items-center gap-4">
                    <Link href="/" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                ...
                <main className="p-6">
                    <div className="mb-8">
                        <div className="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 px-4 py-3 rounded-xl text-sm leading-relaxed border border-blue-100 dark:border-blue-800/50">
                            <span className="font-bold block mb-1">📝 Informasi Pendaftaran</span>
                            Silakan lengkapi data diri Anda di bawah ini. Pastikan nomor WhatsApp aktif untuk kemudahan komunikasi.
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Nomor WhatsApp</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Area / Lokasi (Opsional)</label>
                            <div className="relative">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Alamat Pemasangan</label>
                            <div className="relative">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Paket Diminati</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Catatan Tambahan (Opsional)</label>
                            <div className="relative">
                                <div className="absolute top-3.5 left-0 pl-4 flex items-start pointer-events-none text-slate-400">
                        ...
                        {/* Captcha Widget */}
                        {captchaEnabled && (
                            <div className="flex justify-center py-2" id="turnstile-container" ref={turnstileContainerRef}>
