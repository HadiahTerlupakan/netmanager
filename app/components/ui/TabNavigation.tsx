...
export function TabNavigation({
  ...
  const getTabClasses = (tab: TabItem) => {
    ...
    const baseClasses =
      "relative flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500";
  ...
  const containerClasses = {
    default:
      "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-1 gap-1",
