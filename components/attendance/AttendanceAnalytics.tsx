            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400">
                  {format(week.startDate, "dd MMM", { locale: id })} -{" "}
                  {format(week.endDate, "dd MMM", { locale: id })}
                </span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">
                    {format(new Date(att.checkIn), "EEEE, dd MMMM", {
                      locale: id,
                    })}
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {format(new Date(att.checkIn), "HH:mm", { locale: id })} -{" "}
                    {att.checkOut
                      ? format(new Date(att.checkOut), "HH:mm", { locale: id })
                      : "Belum checkout"}
                  </p>
                </div>
              </div>
