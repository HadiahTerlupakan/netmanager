...
export function NotificationBell() {
  const { unreadCount, loading, isConnected } = useRealtimeNotifications({
    limit: 5,
  });
  ...
  return (
    ...
    >
      ...
      {isConnected && (
        <span
          className="absolute bottom-0.5 right-0.5 w-2 h-2 bg-green-500 rounded-full border border-white dark:border-gray-700"
