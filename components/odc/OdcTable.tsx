...
import { OdcActions } from './OdcActions'
...
export default function OdcTable({ odcs }: OdcTableProps) {
  return (
    <div className="overflow-hidden rounded-md border border-gray-200 dark:border-gray-800">
      <ResponsiveTable
        ...
        renderActions={(item) => <OdcActions id={item.id} status={item.status} />}
        emptyMessage="Belum ada data ODC."
      />
    </div>
  )
}
