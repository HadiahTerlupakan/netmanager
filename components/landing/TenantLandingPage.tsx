...
import { DEFAULT_PUBLIC_APP_LOGO_URL } from "@/lib/settings/publicBranding";

type TenantLandingPageProps = {
  brandingName: string;
  brandingLogoUrl?: string;
  /** Tenant slug — reserved for future use (e.g. tenant-scoped API calls). */
  tenantSlug: string;
};

/** Landing page for tenant subdomains/custom domains with dynamic branding. */
      ...
      <main className="relative flex h-full w-full max-w-md mx-auto flex-col min-h-screen bg-white dark:bg-[#101922] shadow-2xl overflow-hidden">
        ...
        <header className="relative bg-linear-to-b from-teal-50 to-white text-slate-900 pb-20 pt-8 px-6 curved-bottom overflow-hidden shadow-sm z-10 border-b border-slate-100">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link
                href="/dukungan"
                className="text-xs font-semibold bg-white hover:bg-slate-50 text-slate-600 px-3 py-1.5 rounded-full transition-colors border border-slate-200 shadow-sm"
              >
                Bantuan
              </Link>
            </div>
            <div className="mb-8">
              ...
              <p className="text-slate-500 text-[15px] leading-relaxed max-w-[90%] font-medium">
                Rasakan pengalaman browsing, gaming, dan streaming tanpa batas
                bersama {brandingName}.
              </p>
            </div>
        ...
        <section className="px-6 pb-2">
          <h2 className="font-bold text-slate-900 dark:text-white text-lg mb-2 flex items-center gap-2">
            ...
            Tentang {brandingName}
          </h2>
          <p className="text-slate-600 dark:text-slate-400 text-sm mb-6 leading-relaxed">
            Kami adalah penyedia layanan internet fiber optik terdepan yang
            berkomitmen menghadirkan koneksi stabil untuk mendukung
            produktivitas digital keluarga Indonesia.
          </p>
          <div className="grid grid-cols-1 gap-4 mb-8">
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                <h3 className="font-bold text-slate-900 dark:text-white mb-1.5 text-[15px]">
                  Koneksi Hyper-Speed
                </h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Download file besar dalam hitungan detik dengan bandwidth
                  stabil tanpa FUP.
                </p>
              </div>
            </div>
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Infrastruktur kabel tanam bawah tanah yang tahan segala
            ...
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Tim teknis dan customer service kami siap membantu Anda
                  kapanpun dibutuhkan.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <details className="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 open:shadow-md transition-all duration-300">
              <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5">
                <span className="text-slate-900 dark:text-white text-[15px] font-bold">
              ...
              <div className="text-slate-500 dark:text-slate-400 text-sm px-5 pb-5 leading-relaxed">
                Standar waktu pemasangan kami adalah maksimal 3x24 jam setelah
                registrasi dan verifikasi data berhasil dilakukan.
              </div>
            </details>
            <details className="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 open:shadow-md transition-all duration-300">
              <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5">
              ...
              <div className="text-slate-500 dark:text-slate-400 text-sm px-5 pb-5 leading-relaxed">
                Tidak ada. Tagihan bulanan Anda akan tetap (flat) sesuai dengan
                paket yang dipilih selama masa berlangganan aktif.
              </div>
            </details>
            <details className="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 open:shadow-md transition-all duration-300">
              <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-5">
              ...
              <div className="text-slate-500 dark:text-slate-400 text-sm px-5 pb-5 leading-relaxed">
                Kami menerima pembayaran melalui Transfer Bank, Kartu Kredit,
                E-Wallet (GoPay, OVO, Dana), dan gerai minimarket.
              </div>
            </details>
          </div>
        </section>
          ...
          <div className="bg-linear-to-br from-slate-900 to-slate-800 text-white rounded-3xl p-6 relative overflow-hidden shadow-lg">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-slate-300 leading-relaxed">
                Butuh informasi lebih lanjut? Tim kami siap membantu Anda setiap
                saat. Hubungi {brandingName} melalui portal pelanggan atau
        ...
        <footer className="py-8 text-center bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 mt-auto">
          <p className="text-xs text-slate-400 mb-3 font-medium">
            Butuh bantuan sebelum mendaftar?
          </p>
          <Link
            className="inline-flex items-center gap-2 text-[#0f62fe] font-bold text-sm hover:underline decoration-2 underline-offset-2"
            href="/dukungan"
          >
          ...
          <div className="mt-8 text-[11px] text-slate-400 leading-relaxed flex flex-col items-center gap-2">
            <div>
              © {new Date().getFullYear()} {brandingName}. All rights reserved.
            </div>
