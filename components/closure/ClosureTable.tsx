...
import { JoinboxActions } from './JoinboxActions'
...
export default function ClosureTable({ items }: ClosureTableProps) {
  return (
    <div className="overflow-hidden rounded-md border border-gray-200 dark:border-gray-800">
      <ResponsiveTable
        ...
        renderActions={(item) => <JoinboxActions id={item.id} status={item.status} />}
        emptyMessage="Belum ada data JOINbox."
      />
    </div>
  )
}
