...
export default function LandingPage() {
    return (
        <div className="bg-slate-50 dark:bg-[#101922] text-slate-900 dark:text-white font-sans antialiased overflow-x-hidden min-h-screen">
            ...
            <div className="relative flex h-full w-full max-w-md mx-auto flex-col min-h-screen bg-white dark:bg-[#101922] shadow-2xl overflow-hidden">
                ...
                <div className="px-6 pb-10">
                    <div className="bg-slate-900 dark:bg-slate-800 text-white p-6 rounded-3xl relative overflow-hidden shadow-lg">
                        <div className="absolute -top-10 -right-10 size-48 bg-[#0f62fe] rounded-full blur-[60px] opacity-30 pointer-events-none"></div>
                        <div className="absolute -bottom-10 -left-10 size-48 bg-purple-600 rounded-full blur-[60px] opacity-30 pointer-events-none"></div>
                        <div className="relative z-10">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="font-bold text-base tracking-wide uppercase text-slate-400 text-[11px]">Testimoni Pelanggan</h2>
                            ...
                            <div className="bg-white/10 backdrop-blur-md border border-white/10 p-5 rounded-2xl mb-2">
                                ...
                                <p className="text-slate-200 text-sm italic mb-5 leading-relaxed font-medium">
                                    "Sejak pindah ke NetFiber, WFH jadi lancar banget. Zoom meeting nggak pernah putus, anak-anak streaming juga aman. Recommended!"
                                </p>
                                <div className="flex items-center gap-3 border-t border-white/10 pt-4">
                                    <div className="size-9 rounded-full bg-gradient-to-br from-orange-400 to-pink-500 flex items-center justify-center text-xs font-bold shadow-md">AN</div>
                                    <div>
                                        <p className="text-sm font-bold">Andi Nugroho</p>
                                        <p className="text-[11px] text-slate-400 uppercase tracking-wide">Freelancer Designer</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul className="space-y-5">
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-300 mt-1 leading-relaxed opacity-80">Gd. Cyber 2 Tower, Jl. HR Rasuna Said Blok X-5, Jakarta Selatan 12950</p>
                                    </div>
                                </li>
                                <li className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-300 mt-1 opacity-80">1500-888 (24 Jam)</p>
                                    </div>
                                </li>
                                <li className="flex items-center gap-4">
                                    <div className="size-10 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-300 mt-1 opacity-80">care@netfiber.id</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <footer className="py-8 text-center bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 mt-auto">
                    ...
                    <div className="mt-8 text-[11px] text-slate-400 leading-relaxed">
                        © 2023 NetFiber Indonesia. All rights reserved.<br />
