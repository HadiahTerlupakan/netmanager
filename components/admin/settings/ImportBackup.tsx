      ...
      <CardContent className="space-y-6">
        <div className="flex items-start gap-3 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl">
          ...
          <p className="text-xs text-amber-800 dark:text-amber-300 leading-relaxed font-medium">
            Peringatan: Data yang sudah ada <strong>tidak akan dihapus</strong>.
            Hanya data baru yang akan ditambahkan ke database.
          </p>
        </div>
        ...
        {importing && (
          <div className="flex flex-col items-center justify-center py-10 px-4 bg-gray-50/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xs mb-8 mx-auto leading-relaxed">
              Proses ini menyalin data backup ke dalam 4 database secara
              paralel. Harap tunggu dan jangan tutup halaman ini.
            </p>
            <div className="w-full max-w-xs space-y-4">
              <div className="h-2.5 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-amber-400 to-orange-500 rounded-full w-full animate-progress-indeterminate" />
              </div>
