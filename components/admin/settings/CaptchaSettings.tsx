...
import { ShieldCheck, Eye, EyeOff, RefreshCw, CheckCircle2, AlertCircle } from 'lucide-react'
    ...
    return (
      <Card>
        <CardContent className="flex items-center justify-center py-10">
          ...
          <span className="ml-2 text-sm text-gray-500">Memuat pengaturan Captcha...</span>
        </CardContent>
      </Card>
    )
  }
