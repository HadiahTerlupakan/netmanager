...
export function OpnameForm({
    ...
    async function fetchInitialData() {
      try {
        ...
        if (barangRes.ok) {
          ...
          setBarangs(
            Array.isArray(barangResult.barangs)
              ? barangResult.barangs
        ...
        if (gudangRes.ok) {
          ...
          setGudangs(
            Array.isArray(gudangResult.gudangs)
              ? gudangResult.gudangs
              : Array.isArray(gudangResult)
                ? gudangResult
                : [],
          );
        } else {
      ...
      if (formData.barangId && formData.gudangId) {
        try {
          const response = await fetch(
            `/api/inventory/barang/stock?barangId=${formData.barangId}&gudangId=${formData.gudangId}`,
          );
          if (response.ok) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        suhuPenyimpanan: formData.suhuPenyimpanan
          ? parseFloat(formData.suhuPenyimpanan)
          : null,
        kelembaban: formData.kelembaban
          ? parseFloat(formData.kelembaban)
          : null,
      ...
      clientLogger.error("Error saving stock opname:", error);
  ...
  const selectedBarang = Array.isArray(barangs)
    ? barangs.find((b) => b.id === formData.barangId)
    : null;
  const selectedGudang = Array.isArray(gudangs)
    ? gudangs.find((g) => g.id === formData.gudangId)
    : null;
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            ...
            <div>
              ...
              <span
                className={`ml-2 font-medium ${selisih === 0 ? "text-green-600" : selisih > 0 ? "text-blue-600" : "text-red-600"}`}
              >
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, stokFisik: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            placeholder="0"
            min="0"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, kondisiBaik: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, kondisiRusak: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, kondisiExpire: e.target.value })
              }
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          Total kondisi:{" "}
          {parseInt(formData.kondisiBaik) +
            parseInt(formData.kondisiRusak) +
            parseInt(formData.kondisiExpire)}{" "}
          item
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, lokasiPenyimpanan: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, nomorRak: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            placeholder="A-01"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, nomorBox: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            placeholder="BOX-001"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, nomorBatch: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, tanggalExpire: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, suhuPenyimpanan: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            placeholder="25"
            step="0.1"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, kelembaban: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            placeholder="50"
            step="0.1"
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setFormData({ ...formData, catatanDetail: e.target.value })
          }
          rows={3}
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
