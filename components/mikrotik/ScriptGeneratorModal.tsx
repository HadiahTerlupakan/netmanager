...
export default function ScriptGeneratorModal({
  ...
  // Script teplate
  const scriptHost = `/radius add address=${serverIp || "<IP_APLIKASI_INI>"} secret=<SECRET_RADIUS> service=ppp,login,hotspot timeout=3000ms comment="added by netmanager"`;
      ...
      <div className="p-6 space-y-6">
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <p className="text-sm text-blue-800 dark:text-blue-300">
            Script ini digunakan untuk menghubungkan MikroTik ke aplikasi
            NetManager (RADIUS). Silakan copy dan paste script ini ke terminal
            MikroTik Anda.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Masukkan IP Public atau Private dimana aplikasi ini diinstall, yang
            bisa diakses oleh MikroTik.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            >
              {copied ? (
                <HiClipboardDocumentCheck className="w-5 h-5 text-green-400" />
              ) : (
