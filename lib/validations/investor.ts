 ...
 */
export const investorPayoutStatusEnum = z.enum(['PENDING', 'COMPLETED', 'CANCELLED', 'FAILED'])
 ...
 */
export const updateInvestorSchema = investorSchema.partial().extend({
  id: idSchema,
}).refine(
 ...
 */
export const updateInvestorPayoutSchema = investorPayoutSchema.partial().extend({
  id: idSchema,
})
