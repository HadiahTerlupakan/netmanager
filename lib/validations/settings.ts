...
export const generalSettingsSchema = z.object({
  ...
  nomorHp: z.string(),
  email: z.union([
    z.email({ error: "Format email tidak valid" }),
    z.literal(""),
  ]),
  ...
  disablePerpanjanganPaket: z
    .string()
    .min(1, "Batas disable perpanjangan wajib diisi"),
  ...
  autoIsolirHariToleransi: z
    .string()
    .min(1, "Hari toleransi isolir wajib diisi")
    .optional(),
...
export const captchaSettingsSchema = z
  .object({
    enabled: z.boolean(),
...
export const acsTestUrlSchema = z.object({
  url: z.url({ error: "URL ACS tidak valid" }),
});
...
export type PaymentGatewayConfigInput = z.infer<
