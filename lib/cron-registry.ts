...
export class CronRegistry {
    ...
    public startAll() {
        ...
        import('../modules/finance/services/AutomaticBillingService').then(({ AutomaticBillingService }) => {
            ...
            console.log('[CronRegistry] Automatic reminder check cron scheduled (Every minute)')
        }).catch(err => console.error('[CronRegistry] Failed to start Automatic Billing Service:', err))
        ...
        import('../modules/finance/services/AutomaticIsolationService').then(({ AutomaticIsolationService }) => {
            ...
            console.log('[CronRegistry] Automatic isolation cron scheduled (00:00)')
        }).catch(err => console.error('[CronRegistry] Failed to start Automatic Isolation Service:', err))
        ...
        }).catch(err => console.error('[CronRegistry] Failed to start Auto Checkout Service:', err))
        ...
        }).catch(err => console.error('[CronRegistry] Failed to start Location Tracking Service for cleanup:', err))
        ...
        import('../modules/inventory/services/AssetService').then(({ AssetService }) => {
            ...
            console.log('[CronRegistry] Asset depreciation cron scheduled (Monthly 1st 02:00)')
        }).catch(err => console.error('[CronRegistry] Failed to start Asset Service:', err))
        ...
        import('../modules/integrations/services/MixRadiusSyncService').then(({ syncService }) => {
            ...
            console.log('[CronRegistry] MixRadius invoice sync cron scheduled (Hourly)')
            ...
            console.log('[CronRegistry] MixRadius settlement sync cron scheduled (00:05)')
        }).catch(err => console.error('[CronRegistry] Failed to start MixRadius Sync Service:', err))
