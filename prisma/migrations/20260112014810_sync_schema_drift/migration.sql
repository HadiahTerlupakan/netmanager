...
-- DropIndex
DROP INDEX "barang_keluar_gudangId_tanggal_idx";

-- DropIndex
DROP INDEX "barang_keluar_userId_tanggal_idx";

-- DropIndex
DROP INDEX "barang_masuk_gudangId_tanggal_idx";

-- DropIndex
DROP INDEX "barang_masuk_userId_tanggal_idx";
