...
ADD COLUMN     "endWorkTime" TEXT,
ADD COLUMN     "flexibleTargetHour" INTEGER,
...
ADD COLUMN     "startWorkTime" TEXT,
ADD COLUMN     "workDays" TEXT,
ADD COLUMN     "workingHourMode" "WorkingHourMode" NOT NULL DEFAULT 'FIXED',
