...
const QA_ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      "wo_sla:delete",
      "wo_escalation:read",
      "wo_escalation:create",
      "wo_escalation:update",
      "wo_escalation:delete",
      "wo_template:read",
      "wo_template:create",
      "wo_template:update",
      "wo_template:delete",
...
const QA_USERS: UserDefinition[] = [
  {
    email: "qa.readonly@test.com",
    name: "QA Read Only",
    password: "qatest123",
    roleName: "QA_READ_ONLY_ADMIN",
    phone: "+62812-0000-1001",
  },
  {
    email: "qa.workorder@test.com",
    name: "QA Work Order Manager",
    password: "qatest123",
    roleName: "QA_WORKORDER_MANAGER",
    phone: "+62812-0000-1002",
  },
  {
    email: "qa.hr@test.com",
    name: "QA HR Admin",
    password: "qatest123",
    roleName: "QA_HR_ADMIN",
    phone: "+62812-0000-1003",
  },
  {
    email: "qa.network@test.com",
    name: "QA Network Admin",
    password: "qatest123",
    roleName: "QA_NETWORK_ADMIN",
    phone: "+62812-0000-1004",
  },
  {
    email: "qa.support@test.com",
    name: "QA Support Agent",
    password: "qatest123",
    roleName: "QA_SUPPORT_AGENT",
    phone: "+62812-0000-1005",
  },
  {
    email: "qa.sitemanager@test.com",
    name: "QA Site Manager",
    password: "qatest123",
    roleName: "QA_SITE_MANAGER",
    phone: "+62812-0000-1006",
  },
  {
    email: "qa.fieldtech@test.com",
    name: "QA Field Tech Plus",
    password: "qatest123",
    roleName: "QA_FIELD_TECH_PLUS",
    phone: "+62812-0000-1007",
  },

  {
    ...
    password: "qatest123",
    roleName: "QA_NO_PERMISSION",
    phone: "+62812-0000-1008",
  },
];
