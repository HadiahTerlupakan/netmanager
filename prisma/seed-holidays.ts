...
async function main() {
  const holidays = [
    ...
    {
      date: "2025-03-28",
      description: "Cuti Bersama Hari Suci Nyepi",
      isNational: false,
    },
    {
      date: "2025-03-29",
    ...
    {
      date: "2025-04-02",
      description: "Cuti Bersama Idul Fitri 1446 H",
      isNational: false,
    },
    {
      date: "2025-04-03",
    ...
    {
      date: "2025-05-13",
      description: "Cuti Bersama Hari Raya Waisak",
      isNational: false,
    },
    {
      date: "2025-05-29",
    ...
    {
      date: "2025-06-06",
      description: "Hari Raya Idul Adha 1446 H",
      isNational: true,
    },
    {
      date: "2025-06-09",
      description: "Cuti Bersama Idul Adha 1446 H",
      isNational: false,
    },
    {
      date: "2025-06-27",
  ...
  logger.info("Start seeding holidays...");
  ...
  logger.info("Seeding holidays finished.");
}
