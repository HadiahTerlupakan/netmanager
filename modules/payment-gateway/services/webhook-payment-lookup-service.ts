...
export class WebhookPaymentLookupService {
  constructor(
    private readonly paymentRepository = FinanceRepositoryFacade.createPaymentRepository(),
    private readonly unmatchedMutationRepository = FinanceRepositoryFacade.createUnmatchedMutationRepository(),
  ) {}
