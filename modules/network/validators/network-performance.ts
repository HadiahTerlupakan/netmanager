...
/** Validate payload untuk membuat data performa jaringan. */
export const networkPerformanceCreateSchema = z.object({
  ...
  interfaceStatus: z.unknown().optional(),
...
/** Validate query filter untuk daftar performa jaringan. */
...
/** Validate payload untuk membuat alert jaringan. */
...
/** Validate payload untuk mengubah alert jaringan. */
...
/** Validate query filter untuk daftar alert jaringan. */
