...
export class AppVersionMapper {
  ...
  static toDetail(entity: AppVersionWithRelations): AppVersionDetailDTO {
    return {
      ...this.mapBaseDetail(entity),
      createdBy: this.mapCreatedBy(entity),
    };
  }
  ...
  /**
   * Map reusable detail fields from the version entity.
   */
  private static mapBaseDetail(entity: AppVersionWithRelations) {
    return {
      id: entity.id,
      version: entity.version,
      buildNumber: entity.buildNumber,
  ...
  /**
   * Map creator relation into response shape.
   */
  private static mapCreatedBy(entity: AppVersionWithRelations) {
    if (!entity.user) {
      return null;
    }
