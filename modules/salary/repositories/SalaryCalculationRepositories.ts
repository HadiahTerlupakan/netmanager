...
export class UserRepository {
  ...
  async findManySalaryData(
    where: Prisma.UserWhereInput,
  ): Promise<UserSalaryData[]> {
...
export class EmployeeLoanRepository {
  ...
  async updateInTransaction(
    ...
    id: string,
    data: Prisma.EmployeeLoanUpdateInput,
  ) {
  ...
  async createLoanPaymentInTransaction(
    tx: Prisma.TransactionClient,
    data: Prisma.LoanPaymentCreateInput,
  ) {
  ...
  async deleteLoanPaymentInTransaction(
    tx: Prisma.TransactionClient,
    id: string,
  ) {
        ...
        AND: [
          {
            OR: [
              ...
              {
                assignments: {
                  some: { userId: userId, status: { not: "REJECTED" } },
                },
              },
            ],
          },
...
export class SalaryDetailRepository {
  ...
  async createInTransaction(
    tx: typeof prisma,
    data: Prisma.SalaryDetailCreateInput,
  ) {
