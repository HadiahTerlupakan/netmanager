...
export class SalaryRepository {
     ...
     */
    async findByUserPeriod(userId: string, month: number, year: number): Promise<Salary | null> {
        return prisma.salary.findUnique({
            where: {
     ...
     */
    async findAll(filters: SalaryFilters = {}): Promise<{ salaries: SalaryWithDetails[], total: number }> {
     ...
     * Add salary detail
     */
    async addDetail(salaryId: string, detail: Omit<Prisma.SalaryDetailCreateInput, 'salary'>): Promise<SalaryDetail> {
     ...
     */
    async addDetails(salaryId: string, details: Array<Omit<Prisma.SalaryDetailCreateManyInput, 'salaryId'>>): Promise<number> {
     ...
     */
    async getPeriodStats(month: number, year: number): Promise<{
        total: number
        draft: number
        calculated: number
        audited: number
