/**
 * Salary V2 Module — Dependency Factory
 *
 * Wires up repositories and services for the payroll V2 system.
...
import { TaxCalculatorV2, InMemoryTaxHistoryProvider } from "./tax";
...
export function getCalculationEngine() {
  ...
  return new PayrollCalculationEngine([
    ...
    new BpjsCalculator(),
    new TaxCalculatorV2(taxHistoryProvider),
