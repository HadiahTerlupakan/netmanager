...
export class WorkOrderFactory {
     ...
     */
    static async createInstallation(dto: CreateInstallationDTO): Promise<CreateWorkOrderInput> {
     ...
     */
    static async createDisconnection(dto: CreateDisconnectionDTO): Promise<CreateWorkOrderInput> {
        // Fetch pelanggan data for title
        const pelanggan = await prisma.pelanggan.findUnique({
            where: { id: dto.pelangganId },
            select: { nama: true, idPelanggan: true, alamat: true }
        ...
        return {
            ...
            description: this.buildDisconnectionDescription(pelanggan, dto.reason, dto.notes),
            priority: 'NORMAL' as WorkOrderPriority,
            pelangganId: dto.pelangganId,
            departmentId: dto.departmentId,
            siteId: dto.siteId,
     ...
     */
    static createTroubleshooting(dto: CreateTroubleshootingDTO): CreateWorkOrderInput {
        return {
    ...
    static async createRelocation(dto: {
        ...
        return {
            ...
            description: this.buildRelocationDescription(pelanggan, dto.newAddress, dto.notes),
            priority: 'NORMAL' as WorkOrderPriority,
            pelangganId: dto.pelangganId,
            departmentId: dto.departmentId,
            siteId: dto.siteId,
